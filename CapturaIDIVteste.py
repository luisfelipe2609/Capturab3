...
def search_and_display_index(index_name: str):
    if index_name in excel_urls:
        ...
        # Converter os valores da coluna 'part' para números
        df_top_10['part'] = df_top_10['part'].str.replace(',', '.').astype(float)
        
        # Calcular os pesos
        total_part = df_top_10['part'].sum()
        df_top_10['pesos'] = (df_top_10['part'] / total_part) * 100
